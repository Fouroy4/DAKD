...
class Model(nn.Module):
    def __init__(self, num_classes=None, drop_last_stride=False, mutual_information=False, arch = 'resnet50', **kwargs):
        ...
        if arch == 'resnet34':
            self.backbone = resnet34(pretrained=True, drop_last_stride=drop_last_stride)
        self.base_dim = 2048
    ...
    def train_forward(self, feat, labels):
        ...
        # ir_feat = feat.narrow(0,n,n)
        # feat = (rgb_feat + ir_feat) / 2
